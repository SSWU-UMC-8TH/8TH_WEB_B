    ...
    return (
        <div className="flex items-center p-4 border-b border-gray-200">
            ...
            <div className="flex items-center">
                <button onClick={handleDecreaseCount} className="px-3 py-1 bg-gray-300 text-gray-800 rounded-l hover:bg-gray-400 cursor-poiner">-</button>
                <span className="px-4 py-[3px] border-y border-gary-300">{lp.amount}</span>
                <button onClick={handleIncreaseCount} className="px-3 py-1 bg-gray-300 text-gray-800 rounded-r hover:bg-gray-400 cursor-poiner">+</button>
            </div>
        </div>
    )
}
