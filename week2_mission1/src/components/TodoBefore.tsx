...
export const TodoBefore = () => {
    ...
    return (
        <div className="todo-container">
            <h1 className="todo-container__header">YEAN TODO</h1>
                    ...
                    <ul id="todo-list" className="render-container__list">
                        {todos.map((todo): any =>(
                            <li key={todo.id} className="render-container_item">
                                ...
                                <button onClick={() : void => CompleteTodo(todo)} style={{backgroundColor: '#28a745'}} className="render-container__item-button">완료</button>
                                </span>
                            </li>
                        ))}
                    </ul>
                ...
                <div className="render-container__section">
                    ...
                    <ul id="todo-list" className="render-container__list">
                        {doneTodos.map((todo): any =>(
                            <li key={todo.id} className="render-container_item">
                                <span className="render-container__item">{todo.text}
                                <button onClick={() : void => deleteTodo(todo)} style={{backgroundColor: '#dc3535'}} className="render-container__item-button">삭제</button>
                                </span>
                            </li>
                        ))}
                    </ul>
