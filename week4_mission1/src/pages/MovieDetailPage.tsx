      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-black-300 mb-1">평균 {movie.vote_average}</p>
            <p className="text-lg text-black-300 mb-1">{movie.release_date.slice(0, 4)}</p>
            <p className="text-lg text-black-300 mb-4">{movie.runtime}분</p>
            <p className="italic text-blue-300 mb-4">{movie.tagline}</p>
            <p className="text-base text-black-300 leading-relaxed whitespace-pre-line">
              {movie.overview}
            </p>
          </div>
        </div>
